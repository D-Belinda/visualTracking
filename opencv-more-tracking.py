# This is copied from PyImageSearch
...
# defaults to webcam if no video path is provided
# --tracker = OpenCV object tracker to use
...
if int(major) == 3 and int(minor) < 3:
    tracker = cv2.Tracker__create(args["tracker"].upper())
...
while True:
    ...
    if initBB is not None:
        # grab the bounding boc coordinates of the object
